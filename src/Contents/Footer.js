  ...
  return (
    <div className="h-[100vh] flex items-end">
      <div className=" bg-[#5500ff21] items-end  rounded-tl-[15vw] w-full  px-4 py-2">
        <div className="grid grid-cols-2 sm:grid-cols-3 mx-[2vw]  lg:grid-cols-5 items-end gap-4">
          ...
          <div className="h-full">
            <div className="font-semibold mb-2 sm:text-center lg:text-center text-end">NEWSLETTERS</div>
          ...
          <div className="h-full">
            <div className="font-semibold mb-2 sm:text-end lg:text-end text-start">EXTERNALS</div>
