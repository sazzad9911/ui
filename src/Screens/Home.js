    ...
    return (
        <div>
            ...
            <Parallax ref={parallaxRef} pages={5} style={{ top: '0', left: '0' }}>
                ...
                <ParallaxLayer offset={2} speed={.5} style={{ backgroundColor: 'rgba(163, 163, 163, 0.317)' }} />
                <ParallaxLayer
                    offset={2}
                    speed={2}
                    style={{
                ...
                <ParallaxLayer offset={3} speed={1} style={{ backgroundColor: 'rgba(163, 163, 163, 0.317)' }} />
                <ParallaxLayer
                    offset={3}
                    speed={2}
                    style={{
                ...
                <ParallaxLayer offset={4} speed={1} style={{ backgroundColor: 'rgba(163, 163, 163, 0.317)' }} />
                <ParallaxLayer
                    offset={4}
                    speed={2}
                    style={{
